...
export function FlightCardSkeleton({ index }: { index: number }) {
  return (
    <motion.div
      ...
      className="bg-white dark:bg-dark-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6"
    >
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 animate-pulse">
        <div className="flex items-center gap-3 sm:w-36">
          ...
          <div className="space-y-2">
            ...
            <div className="w-14 h-2 bg-slate-100 dark:bg-slate-800 rounded-full" />
          </div>
        </div>
        ...
        <div className="sm:w-36 flex flex-col items-end gap-2">
          <div className="w-12 h-3 bg-slate-100 dark:bg-slate-800 rounded-full" />

...
import { airports } from "@/lib/flight-service";
    ...
    >
      {filtered.slice(0, 5).map((a) => (
        ...
        >
          ...
          <span className="text-xs font-mono font-bold text-primary-600 bg-primary-50 px-2 py-1 rounded-lg group-hover:bg-primary-100">
            {a.code}
          </span>
        </button>
      ))}
      ...
      >
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="flex items-center gap-2 bg-slate-50 rounded-2xl px-4 py-3 border border-slate-200 focus-within:border-primary-400 focus-within:ring-2 focus-within:ring-primary-100 transition-all">
          ...
          {!compact && (
            <div className="hidden lg:flex items-end pb-2 justify-center">
              <button
                type="button"
                onClick={swap}
                className="w-10 h-10 rounded-full bg-primary-50 hover:bg-primary-100 border border-primary-200 flex items-center justify-center transition-all hover:rotate-180 duration-300"
              >
          ...
          <div className="relative">
            ...
            <div className="flex items-center gap-2 bg-slate-50 rounded-2xl px-4 py-3 border border-slate-200 focus-within:border-primary-400 focus-within:ring-2 focus-within:ring-primary-100 transition-all">
              ...
              />
              {destCode && (
                <span className="text-xs font-mono font-bold text-accent-500">
                  {destCode}
                </span>
              )}
            </div>
          ...
          {!compact && (
            <div>
              ...
              <div className="flex items-center gap-2 bg-slate-50 rounded-2xl px-4 py-3 border border-slate-200 focus-within:border-primary-400 focus-within:ring-2 focus-within:ring-primary-100 transition-all">
                ...
                <input
                  type="date"
                  className="bg-transparent w-full text-sm font-medium text-slate-800 outline-none"
                  value={date}

...
function SuccessContent() {
  ...
  const ticketId = `SKV-${Math.random().toString(36).substring(2, 8).toUpperCase()}`;
    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="pt-28 pb-16 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="bg-gradient-to-r from-primary-600 to-primary-700 p-6 text-white">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-mono text-primary-200">
                  {ticketId}
                </span>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8">
              <div className="flex items-center justify-between mb-8">
                <div>
                  <p className="text-4xl font-black text-slate-900">{from}</p>
                  <p className="text-xs text-slate-400 mt-1">{dep}</p>
                </div>
                <div className="flex-1 flex items-center justify-center mx-4">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-[2px] bg-slate-300 rounded-full" />
                    <Plane className="w-5 h-5 text-primary-500 -rotate-0" />
                    <div className="w-8 h-[2px] bg-slate-300 rounded-full" />
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-4xl font-black text-slate-900">{to}</p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
                <div>
                  ...
                  <p className="font-bold text-slate-900 mt-1">{name}</p>
                </div>
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
                    Compagnie
                  </p>
                  <p className="font-bold text-slate-900 mt-1">{airline}</p>
                </div>
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
                    Siège
                  </p>
                  <p className="font-bold text-slate-900 mt-1 text-lg">
                    {seat}
                  </p>
                </div>
                <div>
          ...
          >
            <button className="flex items-center gap-2 bg-white border border-slate-200 text-slate-700 font-semibold px-6 py-3 rounded-2xl hover:bg-slate-50 transition-colors text-sm">
